...
from .manager import ImportManager, Options, Renderer
...
class MegascansDialog(QtWidgets.QDialog):
    def __init__(self, parent: QtWidgets.QWidget | None = None) -> None:
        ...
        self._server.data_received.connect(self._import_manager.handle_data)
        self._init_ui()
    ...
    def _handle_data(self, data: dict) -> None:
        ...
        self._import_manager.import_data(data, options)
...
def show_dialog() -> None:
    ...
    if dialog is None:
        ...
        dialog.setParent(hou.qt.mainWindow(), QtCore.Qt.WindowType.Window)
    dialog.show()
